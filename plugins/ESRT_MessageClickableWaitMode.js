...
/*:
 * @plugindesc メッセージ表示のウェイト中に、入力があればウェイトを無視してテキストを進めることができるようにします。
 * @author 白
 *
 * @help 2019/10/26  ver 1.0.0 
 * メッセージ表示のウェイト中（『\.』：1/4秒待つ、『\|』：1秒待つ）、入力があればウェイトを無視してテキストを進めることができるようにします。
 *   
 *   制御文字     命令
 ...
 *        ボタン押しっぱなしで読み飛ばされず、プレイヤーは長いウェイトを任意で飛ばせます）
 *
 *
 *
 *  利用規約：
